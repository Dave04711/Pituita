...
namespace UnityInspector
{
    ...
    public class FoldoutEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            //if (GUILayout.Button(hideSource ? "Programmer Mode" : "Designer Mode", EditorStyles.miniButtonLeft))
            //{
            ...
            else
            {
                ...
                EditorGUILayout.ObjectField("Sript", MonoScript.FromMonoBehaviour((MonoBehaviour)target), typeof(FoldoutEditor), false);
